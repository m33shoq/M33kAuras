...
stubs.install()
local realG = _G
_G.M33kAuras = stubs.permissive(stubs.newM33kAuras())
...
T.loadAddonFile("M33kAurasOptions/CommonOptions.lua", "M33kAurasOptions", OptionsPrivate)
...
for _, builder in ipairs({ "AddCodeOption" }) do
