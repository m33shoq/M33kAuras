...
local function Constructor()
	...
	local treeframeBG = CreateFrame("Frame", nil, treeframe, "BackdropTemplateWeakAuras")
	...
	local dragger = CreateFrame("Frame", nil, treeframe, "BackdropTemplateWeakAuras")
	dragger:SetWidth(8)
	...
	local border = CreateFrame("Frame", nil, frame, "BackdropTemplateWeakAuras")
